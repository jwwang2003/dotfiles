...
export PROXY_HTTPS="http://${PROXY_HOST}:${PROXY_PORT}"
export PROXY_FTP="http://${PROXY_HOST}:${PROXY_PORT}"

export http_proxy="${PROXY_HTTP}"
export https_proxy="${PROXY_HTTPS}"
export ftp_proxy="${PROXY_FTP}"
export all_proxy="socks5://${PROXY_HOST}:${PROXY_HOST}"
...
# Exclude local address from PROXY
...
proxy_on () {
	...
	export HTTP_PROXY="${PROXY_HTTP}"
	export HTTPS_RPOXY="${PROXY_HTTPS}"
	export FTP_PROXY="${PROXY_FTP}"
	export ALL_PROXY="socks5://${PROXY_HOST}:${PROXY_PORT}"
